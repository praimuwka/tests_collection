...
public class Product extends AbstractProduct<Product> {
     ...
     * Использует обход сверху вниз для проверки наличия циклической зависимости.
     *
    ...
    /**
     * Рекурсивно проверяет, содержит ли текущий продукт указанный продукт в своей иерархии.
